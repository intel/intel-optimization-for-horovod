...
#define HOROVOD_CCL_FIN_THREADS "HOROVOD_CCL_FIN_THREADS"
#define HOROVOD_CCL_FIN_THREAD_COUNT "HOROVOD_FIN_THREAD_COUNT"
#define HOROVOD_CCL_FIN_THREAD_AFFINITY "HOROVOD_FIN_THREAD_AFFINITY"
